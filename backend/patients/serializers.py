...
class PatientContactSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('mothers_name', 'm_address', 'm_contact_number',
                  'fathers_name', 'f_address', 'f_contact_number',
                  'alt_contact_name', 'alt_address', 'alt_contact_number')
...
class PatientClinicalSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('case_number', 'patient_type', 'referring_doctor',
                  'referring_service', 'referral_reason', 'status')


class PatientSerializer(serializers.ModelSerializer):
    class Meta:
        model = Patient
        fields = ('patient_id', 'first_name', 'last_name', 'middle_name',
                  'suffix', 'sex', 'birth_date', 'birth_place', 'street_add',
                  'brgy_add', 'city_add', 'region')
...
class PatientContactClinicalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('patient_id', 'first_name', 'last_name', 'middle_name',
                  'suffix', 'sex', 'birth_date', 'birth_place', 'street_add',
                  'brgy_add', 'city_add', 'region', 'contact', 'clinical')
    ...
    def save(self, validated_data, requester):
        ...
        patient = Patient.objects.create(
            ...
            street_add=validated_data['street_add'],
            brgy_add=validated_data['brgy_add'],
            city_add=validated_data['city_add'],
            region=validated_data['region'],
            created_by=requester)
        contact = PatientContact.objects.create(
            patient=patient,
            mothers_name=contactData['mothers_name'],
            m_address=contactData['m_address'],
            m_contact_number=contactData['m_contact_number'],
            fathers_name=contactData['fathers_name'],
            f_address=contactData['f_address'],
            f_contact_number=contactData['f_contact_number'],
            alt_contact_name=contactData['alt_contact_name'],
            alt_address=contactData['alt_address'],
            alt_contact_number=contactData['alt_contact_number'])
        clinical = PatientClinical.objects.create(
            patient=patient,
            case_number=clinicalData['case_number'],
            patient_type=clinicalData['patient_type'],
            referring_doctor=clinicalData['referring_doctor'],
            referring_service=clinicalData['referring_service'],
            referral_reason=clinicalData['referral_reason'],
    ...
    def update(self, instance, validated_data):
        ...
        instance.birth_date = validated_data.get('birth_date',
                                                 instance.birth_date)
        instance.birth_place = validated_data.get('birth_place',
                                                  instance.birth_place)
        instance.street_add = validated_data.get('street_add',
                                                 instance.street_add)
